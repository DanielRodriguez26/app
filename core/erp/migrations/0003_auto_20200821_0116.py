# Generated by Django 3.1 on 2020-08-21 06:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(default=datetime.datetime.now, verbose_name='Date of birth')),
                ('address', models.CharField(blank=True, max_length=150, null=True, verbose_name='Address')),
                ('sex', models.CharField(choices=[('male', 'Masculino'), ('female', 'Femenino')], default='male', max_length=10, verbose_name='Sex')),
            ],
            options={
                'verbose_name': 'Client',
